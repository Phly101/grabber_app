  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(AppLocalizations.of(context)!.payment, style: Theme.of(context).textTheme.titleMedium),
        centerTitle: true,
      ),
          ...
          children: [
            ...
            Padding(
              ...
              child: Container(
                ...
                child: Center(child: Text(AppLocalizations.of(context)!.confirmAndPay49,style: Theme.of(context).textTheme.bodyMedium,)),
